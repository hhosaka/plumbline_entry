...
<div class="members form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?= $subject ?>（<?= $date ?><?= $start_time ?> 開始）の予約を完了するために以下の項目について入力をお願いします。<br>
        <?php
            echo $information;
            ...
            echo $this->Form->control('email1',['label'=>'メールアドレス','value'=>$email]);
            echo $this->Form->control('confirm1',['label'=>'確認のためもう一度入力してください','value'=>$email]);
    ?>
    </fieldset>
