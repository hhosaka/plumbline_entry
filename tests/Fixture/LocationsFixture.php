...
class LocationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'memo' => ['type' => 'string', 'length' => 1024, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'creation_date' => 1553169685,
                'modification_date' => 1553169685
            ],
        ];
        parent::init();
    }
