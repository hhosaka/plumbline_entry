...
class SchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date_time' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => '0000-00-00 00:00:00', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_creation' => 1563567792,
                'date_modification' => 1563567792
            ],
        ];
        parent::init();
    }
